...
class Proxy {
    ...
    setProxy(proxyConfig) {
        ...
        this.client.interceptors.request.use(config => {
            var _a;
            if (proxyConfig === null || proxyConfig === void 0 ? void 0 : proxyConfig.url) {
                config.headers.set(Object.assign(Object.assign({}, config.headers), { 'x-api-key': (_a = proxyConfig === null || proxyConfig === void 0 ? void 0 : proxyConfig.key) !== null && _a !== void 0 ? _a : '' }), true);
